...
<head>
   <meta charset="utf-8" />
   <title>View Your Stocks | Track Your Shares</title>
...
<div class="row-fluid">
		         ...
		         <div class="metro-nav">
                    ...
                    <div class="metro-nav-block nav-block-blue ">
                     ...
                     <div class="metro-nav-block nav-block-orange ">
                        <a data-original-title="" href="#">
                            <div class="info"><?php echo  (($mystocks[$k]['shares']*$today[$n] )-($mystocks[$k]['shares']*$mystocks[$k]['value'])) ?></div>
                            <div class="status">Profits |<?php echo $mystocks[$k]['shares'] ."@".$mystocks[$k]['value'] ?></div>
                        </a>
                    </div>
</div>
</div>
   ...
   <script type="text/javascript">
    ...
    $("#searchbtn").click(function(){
        ...
        var filter = $("#appendedInputButton").val(), count=0;
 
        
        $(".metro-nav").each(function(){
       ...
       if(count == 0){
       		$("#promptbox").text("Your search matches no records.");
       }
