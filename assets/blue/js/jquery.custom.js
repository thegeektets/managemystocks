    ...
    $(document).ready(function(){
		...
		var ut_word_rotator = function() {
			...
			var ut_rotator_words = [
				'We Love Drinking <span>Coffee</span> with our Olnline Friends',
				'We are Creative and Crazy <span>Professional</span> Coders',
				'We are <span>ThemeCafe</span>, Design and Development agency'
			] ,
			counter = 0;                
		...
		function animate_sections() {
			...
			$('#contact-section').waypoint( function( direction ) {
				...
				if( direction === 'down' && !$(this).hasClass('animated') ) {
					...
					setTimeout ( function () {
							$('#contact-section header').find('.section-title').animate({ opacity: 1 });
					}, 200 );
					
					setTimeout ( function () {
							$('#contact-section header').find('.section-slogan').animate({ opacity: 1 });
					}, 600 );
